...
class Test extends Controller {
    ...
    public function url(){
        redirect('install/index/index');exit;
    }
    ...
    public function test() {
        // 判断写入是否成功
        dump(Env::get('config_path') . 'lock\install.lock');
        dump(file_exists(Env::get('config_path') . 'lock\install.lock'));
    }
